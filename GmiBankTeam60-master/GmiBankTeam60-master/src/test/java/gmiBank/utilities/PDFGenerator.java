...
//  pdfGeneratorRowsAndCells("pdf2","pdf_ders2.pdf");
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirstToTenBank6 (String header, List < Customer > list, String fileName){
    ...
    //derste olusturdugumuz metod
    public static void pdfGeneratorRowsAndCellsWithListFirstToTenBank (String header, List < Customer > list, String fileName){
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirstToTen (String header, List < Customer > list, String
            fileName){
