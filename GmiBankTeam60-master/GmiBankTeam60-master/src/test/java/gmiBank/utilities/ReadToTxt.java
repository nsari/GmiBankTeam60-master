...
//                customer.setSsn(line);
    ...
    public static List<Customer> returnCustomerTeam60(String filePath){
        List<Customer>all = new ArrayList<>();
        try(BufferedReader br = new BufferedReader(new FileReader(ConfigurationReader.getProperty(filePath)))) {
            StringBuilder sb = new StringBuilder();
            String line = br.readLine();
    ...
    public static List<Registration> returnAllStates5(String filePath){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while (line != null) {
                ...
                registration.setSsn(allLine[0]);
                registration.setFirstName(allLine[1]);
                registration.setLastName(allLine[2]);
                registration.setAddress(allLine[3]);
                registration.setMobilePhoneNumber(allLine[4]);
                registration.setUserId(Integer.parseInt(allLine[5]));
                registration.setUserName(allLine[6]);
                registration.setEmail(allLine[7]);
                registration.setCreateDate(allLine[8]);
...
//            System.out.println(line);
    ...
    public static List<States> returnAllStatesTeam60(String filePath){
        List<States>all = new ArrayList<>();
        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            StringBuilder sb = new StringBuilder();
            String line = br.readLine();
    ...
    public static List<Customer> returnCustomerSNNTeam60(String filePath){
        List<Customer>all = new ArrayList<>();
        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            StringBuilder sb = new StringBuilder();
            String line = br.readLine();
    ...
    public static List<String> returnCountry6NameList(String filePath){
        List<String>all = new ArrayList<>();
        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            StringBuilder sb = new StringBuilder();
            String line = br.readLine();
            ...
            while (line != null) {
                ...
                line = br.readLine();
                System.out.println(i++);
                all.add(String.valueOf(country.getName()));
            }
        }catch (Exception e){
            e.printStackTrace();
        }
